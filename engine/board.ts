...
export default class Board {
	...
	private checkPosition(location: Coordinate): Coordinate[] {
		...
		let vertical: Coordinate[] = this.checkPositionDirection(location, Board.CHECK_DIRECTION_UP).concat(
			this.checkPositionDirection(location, Board.CHECK_DIRECTION_DOWN)
		);
		let horizontal: Coordinate[] = this.checkPositionDirection(location, Board.CHECK_DIRECTION_LEFT).concat(
			this.checkPositionDirection(location, Board.CHECK_DIRECTION_RIGHT)
		);
